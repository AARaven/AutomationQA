...
public class AddressSection {
    ...
    @Getter @FindBy( id = "company" )
    private WebElement inputCompany;
    
    @Getter @FindBy( id = "address1" )
    private WebElement inputAddress1;
    
    @Getter @FindBy( id = "address2" )
    private WebElement inputAddress2;
    
    @Getter @FindBy( id = "city" )
    private WebElement inputCity;
    
    @Getter @FindBy( id = "postcode" )
    private WebElement inputZipCode;
    
    @Getter @FindBy( id = "other" )
    private WebElement inputAdditionalInfo;
    
    @Getter @FindBy( id = "phone" )
    private WebElement inputPhone;
    
    @Getter @FindBy( id = "phone_mobile" )
    private WebElement inputPhoneMobile;
    
    @Getter @FindBy( id = "alias" )
    private WebElement inputAlias;
    
    @Getter @FindBy( id = "id_country" )
    private WebElement selectCountry;
    
    @Getter @FindBy( id = "id_state" )
